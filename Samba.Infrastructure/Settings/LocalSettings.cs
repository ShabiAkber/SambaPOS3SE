...
namespace Samba.Infrastructure.Settings
{
    ...
    public static class LocalSettings
    {
        ...
        public static string DataPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\Allagma\\" + AppName; } }   //Changed by Tim GU
        public static string UserPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Allagma\\" + AppName; } }   //Changed by Tim GU
        ...
        public static CultureInfo Culture { get { return _cultureInfo; } }
        ...
        public static string Idapprl    //Added by Tim GU
        {
            get
            {
        ...
        public static string AppName { get { return "SambaPOS3SE"; } }
        ...
        public static IList<string> SupportedLanguages { get { return _supportedLanguages ?? (_supportedLanguages = new[] { "fr", "en", "es", "zh-CN" }); } }
