...
namespace Samba.Presentation.Services
{
    public interface ITicketService
    {
        ...
        TicketCommitResult TicketRefund(Ticket ticket);
        void ForcedCloseTicket(Ticket ticket);
        void SaveTicketData(Ticket ticket);
        ...
        void CancelSelectedOrder(Ticket ticket, Order order);  //Added by Tim GU
    }
}
