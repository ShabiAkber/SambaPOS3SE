...
namespace Samba.Modules.LoginModule
{
    ...
    public class LoginViewModel
    {
        ...
        //public string AppLabel { get { return "SAMBA POS " + LocalSettings.AppVersion + " - " + GetDatabaseLabel(); } }   //Commented by Tim GU
        public string AppLabel { get { return "Alimenté par Allagma SimpleMenu SRS"; } }
