    ...
    public class Calculation : ValueClass
    {
        ...
        public void Update(decimal sum, decimal currentSum, int decimals)
        {
            ...
            else if (CalculationType == 4)
            {
                ...
                else // If the rounding is given as minus, it always rounds down.
            ...
            if ((DecreaseAmount && CalculationAmount > 0)||(!DecreaseAmount && CalculationAmount < 0)) CalculationAmount = 0 - CalculationAmount;
        }
