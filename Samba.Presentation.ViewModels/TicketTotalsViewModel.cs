...
namespace Samba.Presentation.ViewModels
{
    ...
    public class TicketTotalsViewModel : ObservableObject
    {
        ...
        public decimal TicketTPSValue { get { return Model.CalculateTPS(Model.GetPlainSum(), Model.GetPreTaxServicesTotal()); } }
        public decimal TicketTVQValue { get { return Model.CalculateTVQ(Model.GetPlainSum(), Model.GetPreTaxServicesTotal()); } }
        ...
        public bool IsTicketTotalVisible { get { return TicketPaymentValue != 0 && TicketTotalValue != 0; } }  //Modified by Tim GU
        public bool IsTicketPaymentVisible { get { return TicketPaymentValue != 0; } }   //Modified by Tim GU
        public bool IsTicketChangePaymentVisible { get { return TicketChangePaymentValue != 0; } }   //Modified by Tim GU
        public bool IsTicketRemainingVisible { get { return TicketRemainingValue != 0; } }   //Modified by Tim GU
        public bool IsTicketTaxTotalVisible { get { return TicketTaxValue != 0; } }   //Modified by Tim GU
        public bool IsTicketTPSTotalVisible { get { return TicketTPSValue != 0; } }   //Modified by Tim GU
        public bool IsTicketTVQTotalVisible { get { return TicketTaxValue != 0; } }   //Modified by Tim GU
        public bool IsPlainTotalVisible { get { return PostServicesList.Any() || PreServicesList.Any() || IsTicketTPSTotalVisible || IsTicketTVQTotalVisible; } }
        ...
        public string TicketTPSLabel { get { return TicketTPSValue.ToString(LocalSettings.ReportCurrencyFormat); } }
        public string TicketTVQLabel { get { return TicketTVQValue.ToString(LocalSettings.ReportCurrencyFormat); } }
        ...
        private void RefreshAll(object state)
        {
            ...
            RaisePropertyChanged(() => TicketTPSLabel);
            RaisePropertyChanged(() => TicketTVQLabel);
            ...
            RaisePropertyChanged(() => IsTicketTPSTotalVisible);
            RaisePropertyChanged(() => IsTicketTVQTotalVisible);
