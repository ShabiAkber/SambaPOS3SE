...
namespace Samba.Modules.PosModule
{
    ...
    public class TicketViewModel : ObservableObject
    {
        ...
        private void OnChangePrice(string obj)
        {
            ...
            {
                #region SRSOnChangePriceBlock
               
                #endregion   //Region Code Block added by Tim GU, to record the action to change order item price, into SRS DB.
        ...
        private void OnCancelItemCommand(string obj)
        {
            ...
            //    oItem.OrderId = SelectedOrder.Id;
            //    oItem.TicketNo = SelectedTicket.TicketNumber;
            //    oItem.MenuItemId = SelectedOrder.MenuItemId;
            //    oItem.MenuItemName = SelectedOrder.MenuItemName;
            //    oItem.Price = SelectedOrder.Price;
            //    oItem.Quantity = SelectedOrder.Quantity;
            //    oItem.CalculatePrice = SelectedOrder.CalculatePrice ? 1 : 0;
            //    oItem.OrderNumber = SelectedOrder.OrderNumber;
            //    oItem.CreatingUserName = SelectedOrder.CreatingUserName;
            //    oItem.CreatingDateTime = SelectedOrder.CreatedDateTime.ToString("yyyyMMddHHmmss");
            //    oItem.Idapprl = strIdapprl;
            //    oItem.UserName = _applicationState.CurrentLoggedInUser.Name;
            //    oItem.Delete();
            //}
