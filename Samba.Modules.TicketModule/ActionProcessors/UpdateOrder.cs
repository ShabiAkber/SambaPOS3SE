    ...
    class UpdateOrder : ActionType
    {
        ...
        public override void Process(ActionData actionData)
        {
            ...
            if (orders.Any())
            {
                ...
                { 
                    bool bCalculatePrice = actionData.GetAsBoolean("CalculatePrice");  //Added by Tim GU
                    if(order.CalculatePrice && !bCalculatePrice)   //Added by Tim GU. Indicating the scenario to void a submitted order.
                    {
                        _ticketService.CancelSelectedOrder(ticket, order);
                    }
                    ...
                    if (!string.IsNullOrEmpty(actionData.GetAsString("CalculatePrice")))
                        order.CalculatePrice = bCalculatePrice; //actionData.GetAsBoolean("CalculatePrice");  //Modified and commented by Tim GU
